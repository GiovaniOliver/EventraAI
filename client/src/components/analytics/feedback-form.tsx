...
import { submitEventFeedback } from '@/lib/analytics-service';
...
export default function FeedbackForm({ eventId, onSuccess }: FeedbackFormProps) {
  ...
  const onSubmit = async (data: FeedbackFormValues) => {
    try {
      ...
      queryClient.invalidateQueries({ queryKey: ['/api/events/feedback', eventId] });
      queryClient.invalidateQueries({ queryKey: ['/api/events/feedback-summary', eventId] });
