...
import { Home, CalendarCheck, Plus, CheckCircle, User } from "lucide-react";
    ...
    <>
      <nav className="bg-white shadow-lg fixed bottom-0 left-0 right-0 z-10 h-20">
        <div className="flex justify-around items-center h-full">
          ...
          <Link 
            href="/tasks"
            className={`flex flex-col items-center justify-center space-y-1 w-1/5 h-full ${isActive('/tasks') ? 'text-primary-500' : 'text-gray-400 hover:text-primary-500'}`}
          >
